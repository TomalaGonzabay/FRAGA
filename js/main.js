...
const comandos = {
    ...
    "de qué trata el proyecto": () => {
        voz(" Es un proyecto educativo creado por estudiantes de la academia naval fragata Guayas. Este proyecto contiene una informacion importante acerca de la implementación de la IA en la educación.");
    },
    ...
    "fraga buscamé *busqueda": busqueda => {
        voz("ok, buscando " + busqueda +" para ti");
        window.open("https://www.google.com/search?q=" + busqueda)
    },
